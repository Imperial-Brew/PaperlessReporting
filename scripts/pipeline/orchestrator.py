...
class AccountPipeline:
    ...
    def create_validation_pipeline(name: str = "account_validation_pipeline") -> Pipeline:
        ...
        Returns:
            Pipeline instance
        """
        from scripts.pipeline.processors import AccountValidator
    ...
    def create_transformation_pipeline(name: str = "account_transformation_pipeline") -> Pipeline:
        ...
        Returns:
            Pipeline instance
        """
        from scripts.pipeline.processors import AccountValidator, AccountTransformer
    ...
    def create_csv_export_pipeline(output_path: str, name: str = "account_csv_export_pipeline") -> Pipeline:
        ...
        Returns:
            Pipeline instance
        """
        from scripts.pipeline.processors import AccountValidator, AccountTransformer, CSVLoader
    ...
    def create_acquisition_pipeline(output_path: str = None, name: str = "account_acquisition_pipeline") -> Pipeline:
        ...
        Returns:
            Pipeline instance
        """
        from scripts.pipeline.processors import AccountsDataAcquisitionStage, AccountValidator, AccountTransformer, BatchProcessor, CSVLoader
...
class ContactPipeline:
    ...
    def create_validation_pipeline(name: str = "contact_validation_pipeline") -> Pipeline:
        ...
        Returns:
            Pipeline instance
        """
        from scripts.pipeline.processors import ContactValidator
    ...
    def create_transformation_pipeline(name: str = "contact_transformation_pipeline") -> Pipeline:
        ...
        Returns:
            Pipeline instance
        """
        from scripts.pipeline.processors import ContactValidator, ContactTransformer
    ...
    def create_csv_export_pipeline(output_path: str, name: str = "contact_csv_export_pipeline") -> Pipeline:
        ...
        Returns:
            Pipeline instance
        """
        from scripts.pipeline.processors import ContactValidator, ContactTransformer, CSVLoader
    ...
    def create_acquisition_pipeline(output_path: str = None, name: str = "contact_acquisition_pipeline") -> Pipeline:
        ...
        Returns:
            Pipeline instance
        """
        from scripts.pipeline.processors import ContactsDataAcquisitionStage, ContactValidator, ContactTransformer, BatchProcessor, CSVLoader
    ...
    def create_acquisition_pipeline_with_new_script(output_path: str = None, name: str = "contact_acquisition_pipeline_new") -> Pipeline:
        ...
        Returns:
            Pipeline instance
        """
        from scripts.pipeline.processors import NewContactsDataAcquisitionStage, ContactValidator, ContactTransformer, BatchProcessor, CSVLoader
...
class OrderPipeline:
    ...
    def create_validation_pipeline(name: str = "order_validation_pipeline") -> Pipeline:
        ...
        Returns:
            Pipeline instance
        """
        from scripts.pipeline.processors import OrderValidator
    ...
    def create_transformation_pipeline(name: str = "order_transformation_pipeline") -> Pipeline:
        ...
        Returns:
            Pipeline instance
        """
        from scripts.pipeline.processors import OrderValidator, OrderTransformer
    ...
    def create_csv_export_pipeline(output_path: str, name: str = "order_csv_export_pipeline") -> Pipeline:
        ...
        Returns:
            Pipeline instance
        """
        from scripts.pipeline.processors import OrderValidator, OrderTransformer, CSVLoader
    ...
    def create_acquisition_pipeline(output_path: str = None, name: str = "order_acquisition_pipeline") -> Pipeline:
        ...
        Returns:
            Pipeline instance
        """
        from scripts.pipeline.processors import OrdersDataAcquisitionStage, OrderValidator, OrderTransformer, BatchProcessor, CSVLoader
    ...
    def create_order_items_pipeline(output_path: str = None, name: str = "order_items_pipeline") -> Pipeline:
        ...
        Returns:
            Pipeline instance
        """
        from scripts.pipeline.processors import OrderItemValidator, OrderItemTransformer, BatchProcessor, CSVLoader
...
class OrderItemPipeline:
    ...
    def create_validation_pipeline(name: str = "order_item_validation_pipeline") -> Pipeline:
        ...
        Returns:
            Pipeline instance
        """
        from scripts.pipeline.processors import OrderItemValidator
    ...
    def create_transformation_pipeline(name: str = "order_item_transformation_pipeline") -> Pipeline:
        ...
        Returns:
            Pipeline instance
        """
        from scripts.pipeline.processors import OrderItemValidator, OrderItemTransformer
    ...
    def create_csv_export_pipeline(output_path: str, name: str = "order_item_csv_export_pipeline") -> Pipeline:
        ...
        Returns:
            Pipeline instance
        """
        from scripts.pipeline.processors import OrderItemValidator, OrderItemTransformer, CSVLoader
    ...
    def create_extraction_pipeline(order_data: Dict[str, Any], output_path: str = None, name: str = "order_item_extraction_pipeline") -> Pipeline:
        ...
        Returns:
            Pipeline instance
        """
        from scripts.pipeline.processors import OrderItemExtractor, OrderItemValidator, OrderItemTransformer, BatchProcessor, CSVLoader
