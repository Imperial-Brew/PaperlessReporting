"""
[ARCHIVED] Example of using parallel processing in the pipeline framework.

This script has been archived and moved to scripts/Examples/pipeline_parallel_example.py.
